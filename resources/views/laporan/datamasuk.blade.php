...
<div class="widget">
	<div class="widget-header">
		...
		<h3>Cetak Data Masuk</h3>
	</div>

	<div class="widget-content">
		<h2>Cetak laporan obat masuk dalam rentang waktu tertentu</h2>
			<form >
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#mingguan').click(function(event) {
			...
			var url = '{{url('laporan/datamasuk/cetak?')}}'+'tglawal='+tglawal+'&tglakhir='+tglakhir;
