...
<div class="widget">
	<div class="widget-header">
		...
		<h3>Edit #{!! $hutang->supplier->nama_supl !!}</h3>
	</div>

	<div class="widget-content">
		<div class="tab-pane" id="formcontrols">
			{!! Form::model($hutang, ['url'=>'hutangsupplier/'.$hutang->id, 'method'=>'put', 'class'=>'form-horizontal']) !!}
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						{!! Form::input('text', 'jml_hutang', null, ['id'=>'jml_hutang', 'class'=>'span4', 'autofocus']) !!}
